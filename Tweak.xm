...
+ (_V_STR)s1 { return [self _M_DEC:@"\x60\x5B\x52\x57\x5C\x44\x67\x41\x52\x50\x58\x46\x41"]; }
+ (_V_STR)s2 { return [self _M_DEC:@"\x52\x5D\x5C\x6C\x47\x5E\x43"]; }
+ (_V_STR)s3 { return [self _M_DEC:@"\x47\x40\x40\x6C\x47\x5E\x43"]; }
+ (_V_STR)s4 { return [self _M_DEC:@"\x50\x5C\x5E\x1D\x47\x56\x5D\x50\x56\x5D\x47\x1D\x5A\x54"]; }
+ (_V_STR)s5 { return [self _M_DEC:@"\x56\x5E\x51\x56\x57\x57\x56\x57"]; }
+ (_V_STR)s6 { return [self _M_DEC:@"\x5E\x5C\x51\x5A\x5F\x56\x43\x41\x5C\x47\x5A\x52\x5A\x56\x57"]; }
+ (_V_STR)s7 { return [self _M_DEC:@"\x41\x56\x43\x5C\x41\x47"]; }
+ (_V_STR)s8 { return [self _M_DEC:@"\x50\x41\x52\x40\x5B\x40\x5A\x54\x5B\x47"]; }
+ (_V_STR)ui { return [self _M_DEC:@"\x11\x1F\x12\x10\x18"]; }
@end
...
+ (void)Defend {
    // استخدام syscall بدلاً من ptrace المباشر لتجاوز نقص ملفات SDK
...
+ (void)Show {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(8.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        if (!w) return;
        UILabel *l = [[UILabel alloc] initWithFrame:CGRectMake(0, 30, [UIScreen mainScreen].bounds.size.width, 40)];
